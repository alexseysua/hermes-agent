...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Recall past sessions. Omit query to list recent (no cost). With query: FTS5 search — "
        "use OR between keywords for broad recall, \"quotes\" for phrases, NOT/prefix*. "
        "Use when user says 'remember when' or references prior work."
    ),
    "parameters": {
        "type": "object",
        "properties": {
            "query": {
                "type": "string",
                "description": "Keywords/phrases/boolean. Omit to browse recent.",
            },
            "role_filter": {
                "type": "string",
            ...
            "limit": {
                "type": "integer",
                "description": "Max sessions (default 3, max 5)",
                "default": 3,
            },
        },
        "required": [],
