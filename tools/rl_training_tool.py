...
RL_LIST_ENVIRONMENTS_SCHEMA = {"name": "rl_list_environments", "description": "List RL environments.", "parameters": {"type": "object", "properties": {}, "required": []}}
RL_SELECT_ENVIRONMENT_SCHEMA = {"name": "rl_select_environment", "description": "Select RL environment + load defaults.", "parameters": {"type": "object", "properties": {"name": {"type": "string", "description": "Env name"}}, "required": ["name"]}}
RL_GET_CURRENT_CONFIG_SCHEMA = {"name": "rl_get_current_config", "description": "Get modifiable config fields.", "parameters": {"type": "object", "properties": {}, "required": []}}
RL_EDIT_CONFIG_SCHEMA = {"name": "rl_edit_config", "description": "Set a config field (infra settings locked).", "parameters": {"type": "object", "properties": {"field": {"type": "string", "description": "Field"}, "value": {"description": "Value"}}, "required": ["field", "value"]}}
RL_START_TRAINING_SCHEMA = {"name": "rl_start_training", "description": "Start RL training (hours).", "parameters": {"type": "object", "properties": {}, "required": []}}
RL_CHECK_STATUS_SCHEMA = {"name": "rl_check_status", "description": "Get run status/metrics. Rate-limited 30min/run.", "parameters": {"type": "object", "properties": {"run_id": {"type": "string", "description": "Run ID"}}, "required": ["run_id"]}}
RL_STOP_TRAINING_SCHEMA = {"name": "rl_stop_training", "description": "Stop a training run.", "parameters": {"type": "object", "properties": {"run_id": {"type": "string", "description": "Run ID"}}, "required": ["run_id"]}}
RL_GET_RESULTS_SCHEMA = {"name": "rl_get_results", "description": "Get final metrics + weights path.", "parameters": {"type": "object", "properties": {"run_id": {"type": "string", "description": "Run ID"}}, "required": ["run_id"]}}
RL_LIST_RUNS_SCHEMA = {"name": "rl_list_runs", "description": "List training runs.", "parameters": {"type": "object", "properties": {}, "required": []}}
RL_TEST_INFERENCE_SCHEMA = {"name": "rl_test_inference", "description": "Quick inference+scoring via OpenRouter (env verifier check).", "parameters": {"type": "object", "properties": {"num_steps": {"type": "integer", "description": "Steps (3)", "default": 3}, "group_size": {"type": "integer", "description": "Completions per step (16)", "default": 16}, "models": {"type": "array", "items": {"type": "string"}, "description": "OpenRouter model IDs"}}, "required": []}}
