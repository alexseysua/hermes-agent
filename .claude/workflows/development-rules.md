...
- **NEVER** guess at APIs, libraries, formats, or protocols you're uncertain about
- If unfamiliar with a technology: use WebSearch, docs-seeker, or researcher agent FIRST
- If implementation fails on first attempt: STOP, research the actual docs, then retry
- Admitting "I need to research this" is always better than guessing wrong
