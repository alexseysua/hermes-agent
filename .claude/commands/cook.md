...
Parse `$ARGUMENTS` for flags (strip before passing to core logic):
- `--auto` → skip approval steps and user confirmation gates; proceed automatically through all phases
...
* If `--auto` flag detected: skip clarification questions, proceed directly to Research.
...
* If `--auto` flag detected: auto-approve and proceed to Project Management.
* Otherwise: ask user to review the changes and approve them.
* **IMPORTANT:** Sacrifice grammar for the sake of concision when writing outputs.

### Project Management & Documentation

**If user approves the changes (or `--auto` flag detected):**
