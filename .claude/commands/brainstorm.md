...
## Your Process
1. **Discovery Phase**: Use `AskUserQuestion` tool to ask clarifying questions about requirements, constraints, timeline, and success criteria. Follow `.claude/workflows/questioning-methodology.md` for structured requirement elicitation.
