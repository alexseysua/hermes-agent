...
- `agent-teams` skill — Claude Code native multi-agent coordination (parallel execution, shared task management, quality gates). Use when orchestrating Claude subagents; use `google-adk-python` when building Python-based agent systems deployed to Cloud Run / Vertex AI.