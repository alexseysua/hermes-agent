...
This skill is an **optional step** invoked when implementation is blocked. Use it between planning and implementation, or during debugging, whenever standard approaches fail.
