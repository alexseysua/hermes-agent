...
Multi-agent coordination with parallel execution. Requires Claude Code v2.1.32+.
...
Control agent capabilities via frontmatter:
...
---
name: safe-developer
disallowedTools: Bash(rm -rf*|sudo*), Write(*.env)
---
```

### Pattern Syntax

- Comma-separated tool names: `Read, Grep, Glob`
- Glob patterns: `mcp__github__*`
- Bash patterns: `Bash(npm*|pnpm*)`

### See Also

- Agent Teams Reference: `references/agent-teams.md`
