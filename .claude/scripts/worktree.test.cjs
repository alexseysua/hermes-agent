...
const MONOREPO_DIR = process.env.MONOREPO_TEST_DIR || path.join(path.dirname(STANDALONE_DIR), 'claudekit');
...
test('create respects --prefix flag', () => {
  const prefixes = ['feat', 'fix', 'docs', 'refactor', 'test', 'chore', 'ci', 'perf'];
